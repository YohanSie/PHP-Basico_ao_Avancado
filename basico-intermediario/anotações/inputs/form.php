...
<body class="bg-dark">
                ...
                <form action="submissao.php" method="post" name="formulario">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <!-- radiobuttons -->
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="radio" id="radio_1" value="opcao_1" checked>
                                <label for="radio_1" class="form-check-label">Opção 1</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="radio" id="radio_2" value="opcao_2">
                                <label for="radio_2" class="form-check-label">Opção 2</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="radio" id="radio_3" value="opcao_3">
    ...
    <script>
        document.querySelector("#preencher").addEventListener('click', () => {
            ...
            formulario['select'].value = "Brasil";
            formulario['check_1'].checked = true;
            formulario['radio'][1].checked = true;
