...
<body>
    <section>
        ...
        echo "<h5>*Cotação fixa de " . numfmt_format_currency($padrao, $cotacao, "USD") . " informada do <a href='https://dadosabertos.bcb.gov.br/dataset/dolar-americano-usd-todos-os-boletins-diarios/resource/43a16981-5a4b-47d9-b7bd-4c0c4093f994'>Banco Central</a></h5>"
        ?>
