...
// desse usuário
$conection = new PDO("mysql:host=localhost;dbname=$database", $username, $password);

// verificar se a ligação foi estabelecida corretamente
$estado = $conection->getAttribute(PDO::ATTR_CONNECTION_STATUS);
...
Para "desligar" a conexão, bastará destruir o objeto $conection
*/
